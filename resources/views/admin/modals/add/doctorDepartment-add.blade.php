<div class="modal fade right" id="modal-new-doctorDepartment" tabindex="-1" role="dialog" aria-labelledby="modal-new-doctordepartment-label"
     aria-hidden="true" data-backdrop="false">
    <div class="modal-dialog modal-info" role="document">
        <!--Content-->
        <form action="{{ url('admin/doctorDepartment/save') }}"  method="post" accept-charset="utf-8">
            {{ csrf_field() }}

            <div class="modal-content">
                <!--Header-->
                <div class="modal-header" style="background-color: #17A2B8;">
                    <p class="heading">New Doctor Department
                    </p>
