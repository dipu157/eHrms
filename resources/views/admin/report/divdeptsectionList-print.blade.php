        ...
        <tr>
            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    <thead>
                    <tr>
                        <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:12pt;color:#000000; ">Division , Department & Section List</span></td>
                    </tr>
        ...
        <table class="table order-bank" width="80%" cellpadding="2">
            ...
            <thead>
                    <tr  class="row-line">
                        ...
                        <th width="150px" style="font-size: 10px; font-weight: bold; text-align: center">Division Name</th>
                        <th width="150px" style="font-size: 10px; font-weight: bold; text-align: center">Department Name</th>
                        <th width="150px" style="font-size: 10px; font-weight: bold; text-align: center">Section Name</th>
                       
                    </tr>
                </thead>
            <tbody>

            @foreach($sec_list as $i=>$row)

                <tr class="row-line">
                        <td width="40px" style="text-align: left">{!! $i + 1 !!}</td>
                        <td width="150px" style="text-align: center">
                                {!! $row->department->division->name !!}
                        </td>
                        <td width="150px" style="text-align: center">
                                {!! $row->department->name !!}
                        </td>
