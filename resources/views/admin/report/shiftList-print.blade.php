        ...
        <tr>
            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    <thead>
                    <tr>
                        <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:12pt;color:#000000; ">All Active Shift</span></td>
                    </tr>
        ...
        <table class="table order-bank" width="90%" cellpadding="2">
            ...
            <thead>
                    <tr  class="row-line">
                        ...
                        <th width="220px" style="font-size: 10px; font-weight: bold; text-align: center">Shift Name</th>
