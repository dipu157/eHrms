        ...
        <div class="row justify-content-left">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('attendance/informedAbsentSave') }}" >
                            @csrf
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.btn-absent-delete', function () {
            // e.preventDefault();
            ...
            $.ajax({
                ...
                data: {
                    method: '_POST', submit: true, row_id: $('#absent-data-' + item_id).val(),
                },
