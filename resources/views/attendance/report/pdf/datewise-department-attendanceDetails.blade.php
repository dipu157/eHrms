   ...
   <h3 style="font-weight: bold">Department Name : {!! $data[0]->department->name !!}<br/>
    ...
    <table class="table table-info table-striped order-bank">
        ...
        <tr class="row-line">
            ...
            <td style="text-align: left; font-size: 11px; font-weight: bold">Entry Time</td>
            <th style="text-align: left; font-size: 11px; font-weight: bold">Exit Time</th>
            <th style="text-align: left; font-size: 11px; font-weight: bold">Over Time</th>
        ...
        @foreach($data as $i=>$row)
            @if($row->Status == 'Present')
                @php($p++)
                <tr>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $p !!}</td>
                    ...
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! isset($row->entry_time) ? \Carbon\Carbon::parse($row->entry_time)->format('g:i A') :'' !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! isset($row->exit_time) ? \Carbon\Carbon::parse($row->exit_time)->format('g:i A') : '' !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->overtime_hour !!}</td>
    ...
    <table class="table table-secondary table-striped order-bank">
        ...
        @foreach($data as $i=>$row)
            @if($row->Status == 'OffDay')
                @php($off++)
                <tr>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $off !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->employee_id !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->professional->personal->full_name !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->shift->name !!}<br/>{!! \Carbon\Carbon::parse($row->shift->from_time)->format('g:i A') !!} - {!! \Carbon\Carbon::parse($row->shift->to_time)->format('g:i A') !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->Status !!}</td>
    ...
    <table class="table table-secondary table-striped order-bank">
        ...
        @foreach($data as $i=>$row)
            @if($row->Status == 'InLeave')
                @php($lv++)
                <tr>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $lv !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->employee_id !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->professional->personal->full_name !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->shift->name !!}<br/>{!! \Carbon\Carbon::parse($row->shift->from_time)->format('g:i A') !!} - {!! \Carbon\Carbon::parse($row->shift->to_time)->format('g:i A') !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->Status !!}</td>
    ...
    <table class="table table-primary table-striped order-bank">
        ...
        @foreach($data as $i=>$row)
            @if($row->Status == 'Absent')
                @php($ab++)
                <tr>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $ab !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->employee_id !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->professional->personal->full_name !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->shift->name !!}<br/>{!! \Carbon\Carbon::parse($row->shift->from_time)->format('g:i A') !!} - {!! \Carbon\Carbon::parse($row->shift->to_time)->format('g:i A') !!}</td>
                    <td style="border-bottom-width:1px; font-size:9pt; text-align: left">{!! $row->Status !!}</td>
