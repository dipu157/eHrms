            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    ...
                    <tr>
                        ...
                        {!! 'Early Exit Employee Report' !!} </span></td>
                    </tr>
                    <tr>
        ...
        <table class="table order-bank" width="100%" cellpadding="2">
            ...
            <thead>
                ...
                <tr class="row-line">
                    ...
                    <th  width="60px" style="text-align: center; font-size: 10px; font-weight: bold">Date</th>
                    <th  width="100px" style="text-align: center; font-size: 10px; font-weight: bold">Shift Exit Time</th>
            ...
            @foreach($data as $row)
                ...
                @if($emp->employee_id == $row->employee_id)
                    ...
                    <tr>
                        ...
                        <td width="60px" style="border-bottom-width:1px; font-size:8pt; text-align: center">{!! \Carbon\Carbon::parse($row->attend_date)->format('d-M-Y') !!}</td>
                        <td width="100px" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! \Carbon\Carbon::parse($row->shift_exit_time)->format('g:i A') !!}</td>
