            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    ...
                    <tr>
                        ...
                        Absent Report </span>: {!! $employees->count() !!}</td>
                    </tr>
        ...
        @foreach($data as $row)
            @if($dept->department_id == $row->department_id)
                ...
                <tr>
                    ...
                    <td width="150px" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! $row->professional->personal->full_name !!} </td>
                    <td width="150px" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! $row->professional->designation->name !!} </td>
