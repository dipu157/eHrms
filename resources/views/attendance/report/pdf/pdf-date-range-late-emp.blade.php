            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    ...
                    <tr>
                        ...
                        Late Report </span>: {!! $employees->count() !!}</td>
                    </tr>
...
@if($data->contains('department_id',$dept->department_id))
    ...
    <table class="table order-bank" width="90%" cellpadding="2">
        ...
        <tr class="row-line">
            ...
            <th width="90px" style="text-align: left; font-size: 10px; font-weight: bold">Shift</th>
            <th width="50px" style="text-align: left; font-size: 10px; font-weight: bold">Late<br>munute</th>
