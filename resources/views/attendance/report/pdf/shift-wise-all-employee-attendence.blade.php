...
@foreach($dptname as $row)
     @if($row->employee_id == $dept->department->headed_by)
        ...
        <tr>
            ...
            <td width="90px" style="border-bottom-width:1px; border-right-width:1px; font-size:8pt; text-align: left">{!! \Carbon\Carbon::parse($row->joining_date)->format('d-M-Y') !!}</td>
        ...
        @foreach($dptname as $row)
            @if($spt->shift_id == $row->shift_id)
                ...
                <tr>
                    ...
                    <td width="80px" style="border-bottom-width:1px; border-right-width:1px; font-size:8pt; text-align: left">{!! \Carbon\Carbon::parse($row->joining_date)->format('d-M-Y') !!}</td>
