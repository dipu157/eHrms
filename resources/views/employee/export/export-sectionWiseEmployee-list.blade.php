...
<body>
            ...
            <tr>
                ...
                <td style="width:90%">
                    <table style="width:100%" class="order-bank">
                        <thead>
                            <tr>
                                <td style="width:90%;" colspan="2"><span
                                        style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:15pt;color:#000000; ">
                                        {!! $dept_name ?? '' !!} </span></td>
                            </tr>
                        </thead>
                    </table>
            ...
            <table class="table order-bank" width="90%" cellpadding="2">
                <thead>
                    ...
                    <tr class="row-line">
                        ...
                        <th width="70px" style="text-align: center; font-size: 10px; font-weight: bold">Joining Date
                        </th>
                        <th width="110px" style="text-align: center; font-size: 10px; font-weight: bold">Designation
                        </th>
                ...
                <tbody>
                    ...
                    @foreach ($employees as $row)
                        @if ($row->section_id == $sect->section->id)
                            ...
                            <tr class="row-line">
                                <td width="25px" style="font-size:8pt; text-align: center">{!! $sl !!}
                                </td>
                                <td width="30px" style="border-bottom-width:1px; font-size:8pt; text-align: center">
                                    {!! $row->pf_no !!}</td>
                                <td width="50px" style="font-size:8pt; text-align: center">{!! $row->employee_id !!}
                                </td>

                                <td width="120px" style="font-size:8pt; text-align: center">{!! $row->personal->full_name !!}
                                </td>
                                <td width="70px" style="font-size:8pt; text-align: center">{!! \Carbon\Carbon::parse($row->joining_date)->format('d-M-Y') !!}
                                </td>
                                <td width="110px" style="font-size:8pt; text-align: center">{!! $row->designation->name !!}
                                </td>

                                <th width="60px" style="text-align: center; font-size: 10px; font-weight: bold"></th>
    ...
    <div>Total Employee : {!! $employees->count() !!}</div>
