        ...
        <tr>
            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    <thead>
                    <tr>
  <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:15pt;color:#000000; ">  {!! $dept_name ?? '' !!} </span></td>
                </tr>
                    </thead>
                </table>
            </td>
            ...
            @if($row->section_id == $sect->section->id)
                ...
                @php($secname = $employees->where('section_id',$row->section_id))
                    <tr class="row-line">
                        ...
                        <td width="70px" style="font-size:8pt; text-align: center">{!! \Carbon\Carbon::parse($row->joining_date)->format('d-M-Y') !!} </td>
