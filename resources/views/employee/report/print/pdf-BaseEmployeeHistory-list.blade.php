...
<body>
        ...
        <tr>
            <td style="width:90%;"><span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:20pt;color:#000000; ">BRB Hospitals Limited</span>
                <span style="text-align: center; font-size: 15px;"><br>
                    ...
                    <span style="font-family:times; height: 100%; font-size:13pt;color:black;"><u>77, West Panthapath, Dhaka-1215</u></span><br>
    ...
    @if($employees2->contains('department_id',$dept->id))
    ...
    <table class="table order-bank" width="100%" cellpadding="2">
        ...
        <tbody>
            ...
            <tr class="row-border">
                ...
                @if($dept->id == $his->department_id && $row->employee_id == $his->employee_id)
                ...
                @if($dept->id == $rec->department_id && $row->employee_id == $rec->employee_id)
    ...
    <div>Total Manpower : {!! $employees2->count() !!}</div>
