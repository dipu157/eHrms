        ...
        <tr>
            ...
            <td style="width:90%">
                <table style="width:100%">
                    <thead>
                    <tr>
                        <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-size:15pt;color:#000000; ">{{ $status }} Employee Between :{{ $from_date }} to {{ $to_date }}<br/>Total Manpower : {!! $employees->count() !!}</span></td>
    ...
    @if($employees->contains('department_id',$dept->department_id))
        ...
        <table class="table order-bank" width="90%" cellpadding="2">
            ...
            <tr class="row-line">
                ...
                <th width="80px" style="text-align: right; font-size: 10px; font-weight: bold">Effective Date</th>
            ...
            @foreach($employees as $row)            
                @if($dept->department_id == $row->department_id)
                    ...
                    <tr>
                        ...
                        <th width="80px" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! \Carbon\Carbon::parse($row->effective_date)->format('d-M-Y') !!} </th>
