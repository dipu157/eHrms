        ...
        <tr>
            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    <thead>
                    <tr>
                        <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-size:15pt;color:#000000; ">All Employee Between :{{ $from_date }} to {{ $to_date }}<br/>List : {{ $status }}<br/>Total Manpower : {!! $employees->count() !!}</span></td>
                    </tr>
                    </thead>
                </table>
            </td>
...
@elseif($row->working_status_id == 14)
                        ...
                        @endif
                        @if(!empty($row->status_change_date))
                        ...
                        @endif
                        <td width="60px" style="border-bottom-width:1px; font-size:8pt; text-align: right"></td>
