        ...
        <tr>
            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    <thead>
                    <tr>
                        <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:15pt;color:#000000; ">Overtime Report For Department Summary List <br> OT Date  : {!! \Carbon\Carbon::parse($from_date)->format('d-M-Y') !!} To {!! \Carbon\Carbon::parse($to_date)->format('d-M-Y') !!}</span></td>
                    </tr>
...
@if(!empty($data1))
        @php($grandtotal = 0)
                ...
                <div class="card">
                    ...
                    <span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:14pt;color:#000000; ">All Department Wise Total Overtime <br/>
                        </span>
                ...
                <div class="blank-space"></div>
                    ...
                    <table class="table order-bank"  width="90%" cellpadding="2">
                            ...
                            <thead>
                            <tr  class="row-line">
                        <th width="40px" style="font-size: 12px; font-weight: bold; text-align: left">SL</th>
                        <th width="250px" style="font-size: 12px; font-weight: bold; text-align: center">Department Name</th>
                        <th width="100px" style="font-size: 12px; font-weight: bold; text-align: center">Total Overtime</th>
                    ...
                    <td ></td>
                        <td style="text-align: center; font-size: 14px; font-weight: bold">All Department Grand Total</td>
                        <td style="font-size: 12px; font-weight: bold; text-align: center">{!! $grand_total !!}  Hours</td>
