        ...
        <tr>
            ...
            <td style="width:90%">
                ...
                <table style="width:100%" class="order-bank">
                    <thead>
                    <tr>
                        <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:15pt;color:#000000; ">Overtime Report For Reject List <br>{!! $dept_data->name !!}<br> OT Date  : {!! \Carbon\Carbon::parse($from_date)->format('d-M-Y') !!} To {!! \Carbon\Carbon::parse($to_date)->format('d-M-Y') !!}</span></td>
                    </tr>
                    </thead>
                </table>
                @else
                <table style="width:100%" class="order-bank">
                    <thead>
                    <tr>
                        <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:15pt;color:#000000; ">Overtime Report All Department For Reject List <br> OT Date  : {!! \Carbon\Carbon::parse($from_date)->format('d-M-Y') !!} To {!! \Carbon\Carbon::parse($to_date)->format('d-M-Y') !!}</span></td>
                    </tr>
                    </thead>
                </table>
                @endif
    ...
    @if($newdata->contains('ot_date',$date))
        ...
        <table class="table order-bank" width="90%" cellpadding="2">
            ...
            <tr class="row-line">
                ...
                <th width="115px" style="text-align: center; font-size: 10px; font-weight: bold">Shift</th>
                <th width="55px" style="text-align: center; font-size: 10px; font-weight: bold">Punch</th>
                <th width="32px" style="text-align: center; font-size: 10px; font-weight: bold">Apply Hour</th>
                <th width="35px" style="text-align: center; font-size: 10px; font-weight: bold">Punch Hour</th>
                <th width="83px" style="text-align: center; font-size: 10px; font-weight: bold">Reason</th>
                <th width="56px" style="text-align: center; font-size: 10px; font-weight: bold">Reject Date</th>
            ...
            @foreach($newdata as $row)
                ...
                @if($date == $row->ot_date)
                    <tr>
                        ...
                        <td width="115px" style="border-bottom-width:1px;font-size:8pt; text-align: left">ROSTER: {!! $row->shift_entry !!}--{!! $row->shift_exit !!} <br/>
                        ...
                        <td width="32px" style="border-bottom-width:1px; font-size:8pt; text-align: center">{!! $row->ot_hour !!}</td>


                        <td width="35px" style="border-bottom-width:1px; font-size:8pt; text-align: center">{!! $row->overtime_from_punch ?? '' !!}</td>
                        <td width="83px"  style="border-bottom-width:1px; font-size:8pt; color: #7d0000;text-align: center">{!! $row->reject_Reason ?? '' !!}</td>
                        <td width="56px" style="border-bottom-width:1px; font-size:8pt; text-align: center">{!! \Carbon\Carbon::parse($row->finalize_at)->format('d-M-Y') !!}</td>
                    </tr>
                    @php($count++)
                @endif
            @endforeach
