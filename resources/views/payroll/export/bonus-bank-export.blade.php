...
<table class="table order-bank" width="90%" cellpadding="2">
    ...
    <tr>
        <td width="80%" style="font-size:10pt; text-align: left"><span style="font-weight: bold">Subject: Transfer of Tk. {!! number_format($bonus->sum('bonus.net_bonus'),0) !!}/= to respective <span >{!! $bank->id == 4 ? 'SND' :  'SB'   !!}</span> Account holders.</span> <br/>
        </td>
    </tr>
        ...
        <table class="table order-bank" width="90%" cellpadding="2">
            ...
            <tfoot>
                <tr>
                    ...
                    <td style="border-bottom-width:1px; font-size:8pt; text-align: right; font-weight: bold">{!! number_format($bonus->sum('bonus.net_bonus')) !!}</td>
                </tr>
