...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-danger justify-content-center" role="alert">
            <strong>Important! <br/>  </strong> <strong class="blinking font-weight-bold">১। আজকের ভিতর সকল ডিপার্টমেন্ট কে চলতি(জুন) মাসের সকল employee এর Roaster Approve করতে হবে। যদি কোন roaster change হয়ে থাকে তবে প্রথমে তা পরিবর্ত্ন করে নিতে হবে। অন্যথায় বেতন পেতে ঝামেলা হবে। 
            </strong>
        </div>
