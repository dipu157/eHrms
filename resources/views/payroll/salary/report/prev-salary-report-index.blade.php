...
@section('pagetitle')
    <h2 class="no-margin-bottom">Employee wise previous Salary Report</h2>
@endsection
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="get" action="{{ route('payroll/prevSalaryIndex') }}" >
                            @csrf
                            ...
                            <input type="text" name="employee_id" id="employee_id" class="form-control col-md-6" placeholder="Enter ID" autocomplete="off" />
                        </div>
