...
@foreach($departments as $i=>$dept)
    ...
    @if($data->contains('department_id',$dept->id))
        ...
        <table class="table order-bank" width="90%" cellpadding="2">
            ...
            <tr class="row-line">
                ...
                <th width="120px" style="text-align: left; font-size: 10px; font-weight: bold">Location</th>
            ...
            @foreach($data as $row)
                ...
                @php($dptname = $data->where('department_id',$row->department_id))
                    <tr class="row-line">
                        ...
                        <td width="120px" style="font-size:8pt; text-align: left">{!! $row->location->location !!}</td>
        ...
        <div>Department Phone </span>: {!! $dptname->count() !!}</div>
        <div class="blank-space"></div>
    @endif
